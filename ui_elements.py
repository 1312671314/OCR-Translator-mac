...
class ResizableMovableFrame(tk.Toplevel):
    ...
    def __init__(self, parent, initial_geometry, bg_color, title="Movable Window"):
        ...
        if sys.platform == "darwin":  # macOS
            corner_cursor = "crosshair"  # macOS doesn't have diagonal resize cursors
        else:  # Windows/Linux
            corner_cursor = "size_nw_se"
        
        self.resize_nw = tk.Frame(self, bg=bg_color, width=border_width, height=border_width, cursor=corner_cursor)
        self.resize_nw.place(relx=0, rely=0, width=border_width, height=border_width)

        self.resize_ne = tk.Frame(self, bg=bg_color, width=border_width, height=border_width, cursor=corner_cursor)
        self.resize_ne.place(relx=1, rely=0, width=border_width, height=border_width, anchor="ne")

        self.resize_sw = tk.Frame(self, bg=bg_color, width=border_width, height=border_width, cursor=corner_cursor)
        self.resize_sw.place(relx=0, rely=1, width=border_width, height=border_width, anchor="sw")

        self.resize_se = tk.Frame(self, bg=bg_color, width=border_width, height=border_width, cursor=corner_cursor)
